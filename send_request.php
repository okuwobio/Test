...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="aircarft_name" class="control-label">Aircarft Name</label>
                    <input type="text" name="aircarft_name" id="aircarft_name" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="aircarft_registration_number" class="control-label">Aircarft Registration Number</label>
                    <input type="text" name="aircarft_registration_number" id="aircarft_registration_number" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="aircarft_model" class="control-label">Aircarft Model</label>
                    <input type="text" name="aircarft_model" id="aircarft_model" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
